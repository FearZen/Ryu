...
export default function EditGalleryPage({ params }: { params: Promise<{ id: string }> }) {
    ...
    useEffect(() => {
        ...
        async function fetchAlbum() {
            try {
                ...
                setErrorMsg('Failed to load album.')
            } finally {
                setIsLoading(false)
            }
        }
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            setErrorMsg(error.message || 'Failed to update album.')
        } finally {
        ...
        <div className="min-h-screen bg-black text-white">
            ...
            <main className="max-w-3xl mx-auto px-4 py-8">
                <div className="flex items-center gap-4 mb-8">
                    ...
                    <div>
                        <h1 className="text-3xl font-black text-white">Edit Album</h1>
                        <p className="text-slate-400">Manage photos and details for this album.</p>
                    </div>
                </div>
